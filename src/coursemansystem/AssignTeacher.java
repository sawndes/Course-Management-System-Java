...
//AssignTeacher Class that is child class of JFrame and implements ActionListener Interface
public class AssignTeacher extends JFrame implements ActionListener{
    ...
    AssignTeacher(){
       ...
       // Panel Size and Layout
        ...
        add(l3);
        // Textfield to enter level to assign
        t4 = new JTextField();
