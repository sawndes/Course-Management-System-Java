	        ...
	        if(ae.getSource() == b1){
	            try{
	                ...
	                String level = t4.getText();
	                	...
	                	String s1 = "select * from module where courseName = '"+courseName+"' AND level = '"+level+"' AND Type = 'Mandatory' ORDER BY moduleName ASC";
		                ...
		                String sq= "INSERT INTO `marks`(`username`, `moduleName`, `level`, `course`) VALUES ('"+username+"','"+module1+"','"+level+"', '"+courseName+"')";
		                String sq1= "INSERT INTO `marks`(`username`, `moduleName`,`level`, `course`) VALUES ('"+username+"','"+module2+"', '"+level+"','"+courseName+"')";
